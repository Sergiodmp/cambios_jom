        ...
        async def run(self):
            ...
            if order_code != "No":
                la_inform_log = opf.order_file(my_full_name, order_code, \
                           ...
                           artikel_gruppe, oel_sorte, single_reduction,assivieru_ngkz, arkerung_mes,\
                ...
                print("Somos las coils esperando",dact)
...
if __name__ == "__main__":
    ...
    parser.add_argument('-ark', '--arkerung_mes', type=int, metavar='', required=False, default=555, help='arkerung_mes: 0-1000')   #Sergio 19/05     marking surfaces
    # MANAGEMENT DATA
    ...
    globals.string_operations = re.sub(r'[\(\)]', '', globals.string_operations)
    ...
    la_data_df = opf.set_agent_parameters(my_name, my_full_name,0,0,0,\
                                          param_f,artikel_gruppe,oel_sorte,single_reduction,assivieru_ngkz,arkerung_mes,'','','')
